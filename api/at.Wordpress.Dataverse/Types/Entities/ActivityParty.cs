...
namespace at.Wordpress.Dataverse.Types
{
	...
	public partial class ActivityParty : Microsoft.Xrm.Sdk.Entity
	{
		...
		public at.Wordpress.Dataverse.Types.ActivityPointer ActivityPointer_Activity_Parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<at.Wordpress.Dataverse.Types.ActivityPointer>("activitypointer_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<at.Wordpress.Dataverse.Types.ActivityPointer>("activitypointer_activity_parties", null, value);
			}
		}
		...
		public at.Wordpress.Dataverse.Types.Contact Contact_Activity_Parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<at.Wordpress.Dataverse.Types.Contact>("contact_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<at.Wordpress.Dataverse.Types.Contact>("contact_activity_parties", null, value);
			}
		}
		...
		public at.Wordpress.Dataverse.Types.Email Email_Activity_Parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<at.Wordpress.Dataverse.Types.Email>("email_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<at.Wordpress.Dataverse.Types.Email>("email_activity_parties", null, value);
			}
		}
		...
		public at.Wordpress.Dataverse.Types.SystemUser System_User_Activity_Parties
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<at.Wordpress.Dataverse.Types.SystemUser>("system_user_activity_parties", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<at.Wordpress.Dataverse.Types.SystemUser>("system_user_activity_parties", null, value);
			}
		}
